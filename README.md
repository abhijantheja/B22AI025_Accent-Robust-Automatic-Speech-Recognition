...
| File | Description |
|------|-------------|
| `results/evaluation/all_results.json` | Evaluation summary used for the checked-in metrics below |
...
| `results/phase2_adversarial/phase2_best.pt` | Best adversarial model checkpoint from the quick experiment workflow |
...
The checked-in metrics below are taken from `results/evaluation/all_results.json`, generated by the current quick experiment workflow with `--seed 42`.
